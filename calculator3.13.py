...
class Calculator(tk.Tk):
    ...
    def create_widgets(self):
        result_label = tk.Label(self, textvariable=self.result_var, font=("Arial", 16), anchor="e", padx=10, pady=10)
        result_label.grid(row=0, column=0, columnspan=4)

        input_entry = tk.Entry(self, textvariable=self.input_var, font=("Arial", 16), justify="right")
        input_entry.grid(row=1, column=0, columnspan=4, padx=10, pady=10)
        ...
        for button_text, row, col in buttons:
            button = tk.Button(self, text=button_text, width=5, height=2, font=("Arial", 16))
